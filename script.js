...
<gpx version="1.1" creator="Line Runners" xmlns="http://www.topografix.com/GPX/1/1">
 <trk><name>${escapeHtml(name)}</name><trkseg>${trkpts}</trkseg></trk>
  ...
  const ROUTES = [
    ...
    { id: "regents-park", name: "Regent's Park & Primrose Hill", type: "park", leg: "Outer Circle loop + Primrose Hill", start: "Baker Street / Great Portland Street", distance: "3.3 mi (5.3 km)", highlights: "Gardens, boating lake, an old cinder track and the famous city view from Primrose Hill.", suitability: "Something for everyone — flat 2.7mi loop with an optional hill for keen legs.", loop: true, path: [[51.5226, -0.1571], [51.5255, -0.1605], [51.5295, -0.1615], [51.5322, -0.1555], [51.5330, -0.1475], [51.5305, -0.1445], [51.5350, -0.1505], [51.5388, -0.1582], [51.5350, -0.1505], [51.5300, -0.1445], [51.5262, -0.1500], [51.5226, -0.1571]] },
    { id: "diana-memorial", name: "Diana Memorial Run", type: "landmark", leg: "Figure-of-eight through four royal parks", start: "Hyde Park Corner", distance: "7.1 mi (11.4 km)", highlights: "Way-marked with 90 brass plates past Buckingham Palace, St James's, Green & Hyde Parks.", suitability: "Easy navigation, splittable into two loops; some road crossings by the Palace.", loop: true, path: [[51.5028, -0.1527], [51.5015, -0.1445], [51.5014, -0.1419], [51.5024, -0.1360], [51.5030, -0.1310], [51.5045, -0.1360], [51.5050, -0.1428], [51.5040, -0.1500], [51.5028, -0.1527]] },
    { id: "victoria-park", name: "Victoria Park Loop", type: "park", leg: "Perimeter of the 'People's Park'", start: "Hackney Wick / Cambridge Heath", distance: "2.4 mi (3.9 km)", highlights: "Tree-lined avenues with parallel dirt bridle paths, ponds and gardens; flanked by two canals.", suitability: "Sociable and popular — flat, wide paths, lots of runners for company.", loop: true, path: [[51.5358, -0.0450], [51.5360, -0.0360], [51.5385, -0.0320], [51.5415, -0.0350], [51.5420, -0.0410], [51.5405, -0.0470], [51.5378, -0.0500], [51.5358, -0.0450]] },
    { id: "battersea-park", name: "Battersea Park Circuit", type: "park", leg: "Loop via Carriage Drive", start: "Battersea Park Rail / Queenstown Road", distance: "2.3 mi (3.6 km)", highlights: "Riverside park from Albert to Chelsea Bridge with crushed-limestone paths and a track; flat.", suitability: "Great all-paces park — flat, no traffic (track only before 8am).", loop: true, path: [[51.4800, -0.1560], [51.4820, -0.1555], [51.4832, -0.1500], [51.4820, -0.1460], [51.4798, -0.1475], [51.4788, -0.1520], [51.4800, -0.1560]] },
    { id: "greenwich-park", name: "Greenwich Park & Blackheath", type: "park", leg: "Park circuit onto Blackheath", start: "Cutty Sark DLR / Greenwich Rail", distance: "2.2 mi (3.6 km) + Blackheath", highlights: "Royal Observatory, the Meridian, sweeping city views, then the open expanse of Blackheath.", suitability: "Scenery plus a hill challenge — flat north, then three climbs.", loop: false, path: [[51.4827, -0.0096], [51.4805, -0.0057], [51.4785, -0.0020], [51.4769, -0.0005], [51.4730, 0.0000], [51.4690, 0.0060], [51.4670, 0.0090]] },
    { id: "hampstead-heath", name: "Hampstead Heath", type: "trail", leg: "Loop over Parliament Hill & the ponds", start: "Hampstead / Gospel Oak (Overground)", distance: "6 mi (9.7 km)", highlights: "320 hectares of woodland, heath and ponds crowned by the Parliament Hill view.", suitability: "For a confident group — hilly, easy to get lost, keep together; muddy when wet.", loop: true, path: [[51.5555, -0.1530], [51.5580, -0.1550], [51.5600, -0.1580], [51.5640, -0.1610], [51.5690, -0.1625], [51.5710, -0.1670], [51.5670, -0.1740], [51.5610, -0.1770], [51.5570, -0.1760], [51.5555, -0.1530]] },
    { id: "stjames-green", name: "St James's & Green Park", type: "park", leg: "Loop around both parks and the lake", start: "Green Park / St James's Park", distance: "2.6 mi (4.1 km)", highlights: "Green oasis on Buckingham Palace's doorstep with a photo-ready lake and The Mall.", suitability: "Easy short social loop, very photogenic; heavy foot traffic.", loop: true, path: [[51.5067, -0.1428], [51.5058, -0.1360], [51.5045, -0.1320], [51.5024, -0.1340], [51.5014, -0.1419], [51.5035, -0.1442], [51.5050, -0.1440], [51.5067, -0.1428]] },
    { id: "southwark-docks", name: "Southwark Park & the Docks", type: "park", leg: "Park out to Greenland Dock & Thames Path", start: "Surrey Quays / Canada Water", distance: "1.7 mi (2.8 km) , extendable", highlights: "Victorian park linking to Greenland Dock, Russia Dock Woodland and a rare south-bank river corridor.", suitability: "Flexible — flat, quiet, easily lengthened along the docks and river.", loop: false, path: [[51.4980, -0.0498], [51.4958, -0.0520], [51.4945, -0.0480], [51.4915, -0.0450], [51.4950, -0.0430], [51.5000, -0.0470]] },
    { id: "wormwood-scrubs", name: "Wormwood Scrubs", type: "park", leg: "Perimeter loop of 'The Scrubs'", start: "East Acton (Central)", distance: "2.6 mi (4.1 km)", highlights: "Vast open grass with a 960m sealed loop and Grand Union Canal access next door; flat.", suitability: "Roomy and flat for all paces, with the canal as an add-on.", loop: true, path: [[51.5165, -0.2480], [51.5195, -0.2430], [51.5225, -0.2380], [51.5228, -0.2300], [51.5200, -0.2280], [51.5175, -0.2330], [51.5170, -0.2430], [51.5165, -0.2480]] },
    { id: "richmond-park", name: "Richmond Park (Tamsin Trail)", type: "trail", leg: "Perimeter shared-use loop", start: "Richmond (District/Overground)", distance: "7.4 mi (11.9 km)", highlights: "London's largest royal park — wild deer, ancient oaks, Isabella Plantation and big skies on a way-marked gravel loop.", suitability: "A proper long run for a confident group — gently hilly, traffic-free, easy to follow.", loop: true, path: [[51.4530, -0.2880], [51.4560, -0.2560], [51.4380, -0.2400], [51.4270, -0.2680], [51.4380, -0.2950], [51.4530, -0.2880]] },
    ...
    { id: "thames-putney-richmond", name: "Thames Path: Putney → Richmond", type: "river", leg: "Boat Race course to Richmond", start: "Putney Bridge (District)", distance: "5.2 mi (8.4 km)", highlights: "The Championship Course along the river past Barnes and Kew Gardens to riverside Richmond.", suitability: "Flat riverside miles — scenic and easy to follow; can be muddy in patches.", loop: false, path: [[51.4670, -0.2160], [51.4750, -0.2450], [51.4700, -0.2800], [51.4610, -0.3080]] },
    ...
    { id: "saucony-london-10k", name: "Saucony London 10K", type: "race", leg: "Piccadilly → Regent Street → Trafalgar Square → Embankment → Whitehall", start: "Green Park (Piccadilly start pens)", distance: "6.2 mi (10 km)", highlights: "July's closed-road city 10K: Piccadilly to a Regent Street out-and-back, Trafalgar Square at 3k, the Strand and Aldwych down to the Victoria Embankment past Somerset House, a Blackfriars turn, then Big Ben and a Westminster Bridge out-and-back before the Whitehall finish.", suitability: "Flat, fast and completely central; every corner is a photo stop and there's a station within minutes all the way. Indicative line traced from the course description.", loop: false, path: [[51.5065, -0.1444], [51.5074, -0.1416], [51.5089, -0.1367], [51.5101, -0.1340], [51.5125, -0.1394], [51.5152, -0.1418], [51.5125, -0.1394], [51.5101, -0.1340], [51.5085, -0.1322], [51.5074, -0.1310], [51.5079, -0.1281], [51.5104, -0.1200], [51.5130, -0.1163], [51.5136, -0.1112], [51.5115, -0.1173], [51.5107, -0.1155], [51.5111, -0.1080], [51.5110, -0.1044], [51.5100, -0.1170], [51.5073, -0.1223], [51.5030, -0.1236], [51.5008, -0.1220], [51.5006, -0.1188], [51.5008, -0.1240], [51.5007, -0.1262], [51.5033, -0.1263], [51.5049, -0.1260]] },
    { id: "london-winter-run", name: "London Winter Run 10K", type: "race", leg: "Trafalgar Square → Holborn → St Paul's → Bank → Embankment → Whitehall", start: "Charing Cross / Trafalgar Square (north terrace)", distance: "6.2 mi (10 km)", highlights: "February's closed-road charity 10K for Cancer Research UK: the Strand and Kingsway up to Holborn, Fleet Street and Ludgate Hill past St Paul's, Cheapside to the Bank of England, then Cannon Street and Queen Victoria Street to Blackfriars and the Embankment home to a Whitehall finish by Downing Street.", suitability: "Flat winter miles with huskies, penguins and a snow zone on course; run it any Sunday for the same City landmarks without the crowds. Indicative line traced from the closure map.", loop: false, path: [[51.5086, -0.1280], [51.5090, -0.1250], [51.5104, -0.1200], [51.5130, -0.1163], [51.5152, -0.1190], [51.5175, -0.1120], [51.5178, -0.1090], [51.5152, -0.1078], [51.5142, -0.1070], [51.5138, -0.1040], [51.5139, -0.1005], [51.5138, -0.0984], [51.5136, -0.0930], [51.5133, -0.0900], [51.5133, -0.0886], [51.5140, -0.0866], [51.5152, -0.0846], [51.5155, -0.0870], [51.5150, -0.0890], [51.5140, -0.0895], [51.5133, -0.0886], [51.5127, -0.0880], [51.5115, -0.0940], [51.5120, -0.0965], [51.5117, -0.1000], [51.5112, -0.1030], [51.5105, -0.1043], [51.5112, -0.1105], [51.5100, -0.1170], [51.5073, -0.1223], [51.5030, -0.1236], [51.5010, -0.1240], [51.5007, -0.1262], [51.5040, -0.1262]] },
    { id: "run-shoreditch-half", name: "Run Shoreditch Half", type: "race", leg: "Shoreditch Park → Newington Green → Clissold Park → De Beauvoir → Hoxton → Shoreditch Park", start: "Old Street / Shoreditch Park (Shepperton Road)", distance: "13.1 mi (21.1 km)", highlights: "September's closed-road half through the best of N1 and N16: up the Essex Road corner and Southgate Road to Newington Green, out to St Paul's Road, Highbury and Queen's Drive, through Clissold Park and Stoke Newington Church Street, back down Albion Road — the Green sees you on three sides — then the De Beauvoir grid, over the Regent's Canal on Whitmore Road and down Hoxton Street past the market to finish by Shoreditch Park.", suitability: "Flat and PB-friendly with cafés at every corner for the support crew. The official 2026 half map isn't published yet — indicative trace of the organisers' confirmed roads (20.9 km); for last year's measured course see the Run Shoreditch 10K.", loop: true, path: [[51.5362, -0.0890], [51.5390, -0.0940], [51.5400, -0.0963], [51.5428, -0.0928], [51.5436, -0.0895], [51.5445, -0.0855], [51.5480, -0.0840], [51.5505, -0.0822], [51.5528, -0.0842], [51.5530, -0.0862], [51.5520, -0.0875], [51.5482, -0.0975], [51.5470, -0.1010], [51.5520, -0.1000], [51.5562, -0.0988], [51.5612, -0.1000], [51.5652, -0.0952], [51.5638, -0.0892], [51.5622, -0.0885], [51.5636, -0.0830], [51.5623, -0.0790], [51.5592, -0.0827], [51.5556, -0.0849], [51.5522, -0.0865], [51.5512, -0.0828], [51.5498, -0.0800], [51.5468, -0.0808], [51.5450, -0.0812], [51.5445, -0.0835], [51.5448, -0.0790], [51.5455, -0.0785], [51.5452, -0.0765], [51.5438, -0.0768], [51.5430, -0.0795], [51.5420, -0.0800], [51.5424, -0.0815], [51.5435, -0.0845], [51.5410, -0.0845], [51.5404, -0.0815], [51.5400, -0.0772], [51.5380, -0.0778], [51.5370, -0.0790], [51.5360, -0.0795], [51.5348, -0.0798], [51.5346, -0.0780], [51.5320, -0.0787], [51.5299, -0.0800], [51.5297, -0.0818], [51.5312, -0.0824], [51.5340, -0.0836], [51.5347, -0.0852], [51.5358, -0.0860]] },
    { id: "run-shoreditch-10k", name: "Run Shoreditch 10K", type: "race", leg: "Shoreditch Park → Newington Green → De Beauvoir → Hoxton → Shoreditch Park", start: "Old Street / Shoreditch Park (Bridport Place)", distance: "6.2 mi (10 km)", highlights: "The 2025 closed-road course, street for street from the official route map: Bridport Place over the Regent's Canal, Rotherfield Street and Ecclesbourne Road, the long Southgate Road climb to Newington Green, the Matthias–Boleyn–Mildmay loop at the top, back through De Beauvoir's grid — Tottenham, Buckingham, Stamford, round De Beauvoir Square — then Downham Road, Hertford Road and Whitmore Road over the canal to Hoxton Street, finishing on Mintern Street by Shoreditch Park.", suitability: "Exact race-day geometry assembled from the official map on real street lines (10.0 km, kilometre markers align within ~100 m) — run it as last year's field did.", loop: true, path: [[51.5352, -0.0864], [51.5374, -0.0866], [51.5379, -0.0889], [51.5407, -0.0930], [51.5422, -0.0903], [51.5414, -0.0862], [51.5395, -0.0867], [51.5395, -0.0857], [51.5438, -0.0846], [51.5466, -0.0838], [51.5511, -0.0848], [51.5520, -0.0848], [51.5517, -0.0794], [51.5495, -0.0777], [51.5505, -0.0833], [51.5489, -0.0830], [51.5490, -0.0844], [51.5458, -0.0837], [51.5454, -0.0795], [51.5456, -0.0809], [51.5449, -0.0810], [51.5444, -0.0770], [51.5427, -0.0802], [51.5425, -0.0777], [51.5416, -0.0781], [51.5416, -0.0805], [51.5428, -0.0815], [51.5412, -0.0819], [51.5393, -0.0824], [51.5395, -0.0867], [51.5391, -0.0787], [51.5373, -0.0793], [51.5375, -0.0817], [51.5356, -0.0823], [51.5330, -0.0810], [51.5297, -0.0801], [51.5298, -0.0832], [51.5332, -0.0830], [51.5332, -0.0850]] },
    { id: "hackney-half", name: "Hackney Half", type: "race", leg: "Hackney Marshes → Hackney Central → Dalston → London Fields → Victoria Park → Hackney Wick → Hackney Marshes", start: "Hackney Wick / Homerton (Hackney Marshes festival village)", distance: "13.1 mi (21.1 km)", highlights: "May's flat, flowing closed-road half through the heart of Hackney: Homerton to Hackney Downs, the Town Hall and Empire on Mare Street, Dalston and Kingsland High Street, London Fields and Broadway Market, a Haggerston loop into Victoria Park around halfway, then Hackney Wick's canalside warehouses and the Olympic Park fringe back to the Marshes.", suitability: "The classic East London half — barely a bump all the way round, with Overground stations never far. Indicative line traced from the course narrative.", loop: true, path: [[51.5545, -0.0330], [51.5520, -0.0395], [51.5470, -0.0450], [51.5462, -0.0520], [51.5510, -0.0555], [51.5535, -0.0560], [51.5545, -0.0640], [51.5530, -0.0680], [51.5490, -0.0640], [51.5455, -0.0555], [51.5468, -0.0640], [51.5478, -0.0720], [51.5462, -0.0755], [51.5480, -0.0755], [51.5520, -0.0745], [51.5462, -0.0755], [51.5420, -0.0768], [51.5412, -0.0700], [51.5410, -0.0625], [51.5390, -0.0605], [51.5378, -0.0615], [51.5362, -0.0620], [51.5360, -0.0680], [51.5330, -0.0700], [51.5305, -0.0640], [51.5320, -0.0565], [51.5330, -0.0530], [51.5355, -0.0490], [51.5340, -0.0400], [51.5352, -0.0320], [51.5385, -0.0420], [51.5378, -0.0430], [51.5400, -0.0310], [51.5410, -0.0295], [51.5435, -0.0245], [51.5445, -0.0220], [51.5490, -0.0195], [51.5520, -0.0260], [51.5545, -0.0325]] },
    { id: "london-landmarks-half", name: "London Landmarks Half Marathon", type: "race", leg: "Whitehall → Westminster Bridge → Tower of London → the City → Trafalgar Square", start: "Westminster (Whitehall start line)", distance: "13.1 mi (21.1 km)", highlights: "April's giant charity half from Tommy's, on closed roads through both Westminster and the City: off Whitehall past Big Ben for a Westminster Bridge out-and-back, the Victoria Embankment and Thames Street to a Tower of London turnaround, then a Square Mile treasure hunt round Bank, Guildhall and Moorgate, Holborn Viaduct and a High Holborn turn, Chancery Lane to Fleet Street with a Temple Place dip to the river, St Paul's via New Change, and the Embankment home to finish by Trafalgar Square.", suitability: "Flat bar the gentle City rises, and never more than minutes from a station. Street-exact from the official 2026 course GPX (20.9 km measured line) — ballot entry on race day, but the roads are there any Sunday.", loop: false, path: [[51.5014, -0.1261], [51.5008, -0.1193], [51.5010, -0.1240], [51.5057, -0.1228], [51.5088, -0.1202], [51.5107, -0.1148], [51.5111, -0.0954], [51.5090, -0.0821], [51.5098, -0.0751], [51.5091, -0.0823], [51.5109, -0.0930], [51.5121, -0.0927], [51.5122, -0.0957], [51.5127, -0.0952], [51.5127, -0.0925], [51.5138, -0.0922], [51.5133, -0.0899], [51.5123, -0.0934], [51.5110, -0.0872], [51.5132, -0.0888], [51.5134, -0.0849], [51.5137, -0.0911], [51.5148, -0.0906], [51.5135, -0.0889], [51.5148, -0.0855], [51.5150, -0.0911], [51.5168, -0.0914], [51.5165, -0.0940], [51.5157, -0.0946], [51.5154, -0.0921], [51.5139, -0.0925], [51.5146, -0.0967], [51.5158, -0.0970], [51.5151, -0.0977], [51.5176, -0.1063], [51.5183, -0.1139], [51.5181, -0.1159], [51.5182, -0.1138], [51.5138, -0.1111], [51.5133, -0.1160], [51.5110, -0.1149], [51.5113, -0.1137], [51.5128, -0.1145], [51.5134, -0.1130], [51.5142, -0.1065], [51.5146, -0.1096], [51.5177, -0.1076], [51.5146, -0.0969], [51.5130, -0.0964], [51.5135, -0.0998], [51.5128, -0.0957], [51.5120, -0.0958], [51.5121, -0.1020], [51.5113, -0.1022], [51.5112, -0.0958], [51.5107, -0.1155], [51.5091, -0.1199], [51.5065, -0.1224], [51.5074, -0.1270], [51.5087, -0.1254], [51.5079, -0.1268]] },
    { id: "burgess-park", name: "Burgess Park", type: "park", leg: "Burgess Park loop", start: "Burgess Park", distance: "2.3 mi (3.6 km)", highlights: "A regenerated south London park with a fishing lake, man-made hills for sprints and the traffic-free old Surrey Canal alignment toward Peckham.", suitability: "Flat. Indicative line traced from the Runner's Guide to London (2015).", loop: true, path: [[51.4839, -0.07683], [51.48315, -0.07698], [51.48269, -0.08574], [51.48336, -0.08769], [51.48341, -0.08783], [51.48349, -0.0876], [51.48353, -0.0879], [51.48414, -0.08554], [51.4859, -0.08024], [51.48661, -0.08087], [51.48733, -0.07932], [51.48866, -0.07772], [51.48884, -0.07808], [51.48864, -0.07719], [51.48897, -0.07773], [51.48891, -0.07799], [51.48884, -0.07808], [51.48866, -0.07772], [51.48661, -0.08087], [51.4858, -0.08025], [51.48457, -0.08396], [51.48343, -0.0836], [51.48338, -0.08396], [51.48374, -0.08369], [51.48432, -0.07961], [51.48426, -0.07675]] },
    { id: "sutcliffe-park", name: "Sutcliffe Park", type: "park", leg: "Eltham loop", start: "Kidbrooke Station", distance: "1.6 mi (2.5 km)", highlights: "A compact wetland park with a running track and figure-of-eight trails ideal for pacing reps.", suitability: "Indicative line traced from the Runner's Guide to London (2015).", loop: true, path: [[51.45475, 0.02935], [51.45445, 0.02931], [51.45423, 0.02962], [51.45423, 0.03027], [51.45436, 0.03042], [51.45351, 0.03144], [51.4534, 0.03277], [51.4536, 0.03434], [51.45328, 0.03441], [51.45342, 0.03665], [51.4533, 0.03701], [51.45296, 0.03727], [51.45244, 0.04235], [51.45161, 0.04588], [51.45152, 0.04892], [51.45121, 0.05084], [51.45087, 0.05182], [51.45079, 0.05501], [51.45093, 0.06033], [51.45081, 0.06241], [51.45087, 0.06258], [51.4511, 0.06258]] },
    { id: "danson-park", name: "Danson Park", type: "park", leg: "Bexleyheath loop", start: "Welling Station", distance: "1.4 mi (2.3 km)", highlights: "One of London's top suburban parks, circling a large boating lake past a grand Georgian mansion.", suitability: "Flat. Indicative line traced from the Runner's Guide to London (2015).", loop: true, path: [[51.45824, 0.11522], [51.45786, 0.11639], [51.45763, 0.11577], [51.45715, 0.11534], [51.45647, 0.11536], [51.45626, 0.11468], [51.45605, 0.11439], [51.45572, 0.11438], [51.45518, 0.11344], [51.45298, 0.11603], [51.45219, 0.11852], [51.45298, 0.11603], [51.45518, 0.11344], [51.45572, 0.11438], [51.45605, 0.11439], [51.45642, 0.11514], [51.45644, 0.11716], [51.45628, 0.11813], [51.4564, 0.11815], [51.45628, 0.11813], [51.45642, 0.11708], [51.45654, 0.117], [51.45699, 0.11724], [51.45749, 0.11696], [51.45794, 0.11622]] },
  ...
  async function loadRouteGpx(slug) {
    ...
    try {
      // routes/<slug>.json holds exactly the [lat, lon, ele] segments this used to
      // parse out of the XML. GitHub Pages does not compress .gpx, so reading the
      // GPX cost up to 432 KB uncompressed for geometry that gzips to under 40 KB
      // as JSON. The .gpx file stays as the download format for watches, and stays
      // the fallback here, so a route whose JSON twin is missing draws slowly
      // rather than not at all. tools/generate-route-json.mjs writes the twins.
      let segs = null;
      const res = await vfetch(`routes/${slug}.json`);
      if (res.ok) {
        const parsed = await res.json();
        if (Array.isArray(parsed)) segs = parsed.filter((s) => Array.isArray(s) && s.length > 1);
      } else if (res.status !== 404) {
        throw new Error("route json " + res.status);
      }
      if (!segs || !segs.length) {
        const gpx = await vfetch(`routes/${slug}.gpx`);
        if (gpx.status === 404) { routeGpxCache[slug] = null; return null; } // genuinely no file — remember that
        if (!gpx.ok) throw new Error("gpx " + gpx.status);
        const doc = new DOMParser().parseFromString(await gpx.text(), "application/xml");
  ...
  function createSiteMap(el, opts = {}) {
    ...
    // CARTO Voyager is the default because it needs no API key. The OS street
    // atlas is still one click away, but it rides on a public key with a usage
    // quota, so making it the default meant a traffic spike could exhaust the
    // quota and leave every visitor with no basemap at all. A key problem now
    // costs the alternative view instead of the main one.
    bases["Voyager"].addTo(map);
  ...
  async function renderSuperloopRoutes() {
    ...
    const build = (card) => {
      const rt = routes[+card.dataset.i], c = colOf(rt);
      // Per-card running direction, kept on the card so it survives a rebuild
      // (unit toggle, interchange arrival). Reverse flips the stops + geometry so
      // the strip, measured stretch and watch exports all run the other way.
      const rev = !!card._slRev;
      const fwd = rt.stops;
      const wp = rev ? fwd.slice().reverse() : fwd;
      const from = wp[0][0], to = wp[wp.length - 1][0];
      ...
      // Reverse — flip the running direction. A pure flip keeps a measured
      // stretch's physical ends, so remap the picked indices then rebuild.
      body.querySelector(".sl-reverse").addEventListener("click", () => {
        card._slRev = !rev;
        const p = card._slPicks;
        if (p) { if (p.a >= 0) p.a = fwd.length - 1 - p.a; if (p.b >= 0) p.b = fwd.length - 1 - p.b; }
        build(card);
      });
      body.dataset.built = "1";
