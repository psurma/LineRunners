...
<gpx version="1.1" creator="TubeRun" xmlns="http://www.topografix.com/GPX/1/1">
 <trk><name>${escapeHtml(name)}</name><trkseg>${trkpts}</trkseg></trk>
  ...
  const ROUTES = [
    ...
    { id: "run-shoreditch-half", name: "Run Shoreditch Half", type: "race", leg: "Shoreditch Park → Newington Green → Clissold Park → Stoke Newington → Shoreditch Park", start: "Old Street / Shoreditch Park (Bridport Place)", distance: "13.1 mi (21.1 km)", highlights: "September's closed-road half through the best of N1 and N16: Hoxton Street market and the Regent's Canal, De Beauvoir's leafy squares, then the Stoke Newington circuit — St Paul's Road, Highbury, Queen's Drive, Clissold Park and Church Street — run twice, so Newington Green sees you three times before the Essex Road run home.", suitability: "Flat and PB-friendly with cafés at every corner for the support crew. Indicative trace of the confirmed roads — the organisers' exact lap line may differ.", loop: true, path: [[51.5368, -0.0862], [51.5390, -0.0885], [51.5358, -0.0800], [51.5320, -0.0788], [51.5358, -0.0800], [51.5362, -0.0830], [51.5405, -0.0838], [51.5445, -0.0855], [51.5455, -0.0900], [51.5520, -0.0868], [51.5485, -0.0975], [51.5462, -0.1030], [51.5520, -0.1000], [51.5570, -0.0985], [51.5620, -0.1000], [51.5655, -0.0955], [51.5645, -0.0900], [51.5620, -0.0880], [51.5605, -0.0855], [51.5625, -0.0790], [51.5590, -0.0830], [51.5555, -0.0850], [51.5522, -0.0862], [51.5560, -0.0935], [51.5600, -0.0895], [51.5605, -0.0855], [51.5625, -0.0790], [51.5590, -0.0830], [51.5555, -0.0850], [51.5518, -0.0870], [51.5480, -0.0890], [51.5432, -0.0930], [51.5400, -0.0975], [51.5390, -0.0990], [51.5410, -0.0958], [51.5420, -0.0880], [51.5408, -0.0805], [51.5390, -0.0845], [51.5370, -0.0858]] },
